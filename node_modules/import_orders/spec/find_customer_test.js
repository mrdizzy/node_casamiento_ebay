                    ...
                    db.save("time", {
                        ...
                        if (err) {
                            ...
                            db.save('_design/customers', {
                                ...
                                db.save({EIASToken: 'nY+sHZ2PrBmdj6wVnY+sEZ2PrA2dj6wFk4CoAZeCoAqdj6x9nY+seQ==' }, function(e, r) {
                                    callback(res);
                                })
                            });
    ...
    "When importing a single order with a single transaction": {
        ...
        "after polling the database": {
            ...
            "the order should be successfully added": function(topic) {
                assert.equal(4, topic.length, "Should be 2 but is " + topic.length + ": " + topic);
            }
        }
    }
}).run();